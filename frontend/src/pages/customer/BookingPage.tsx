      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 flex flex-col gap-4">
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm flex flex-col gap-2">
            <h3 className="text-sm font-medium text-gray-800">Chính sách hủy phòng</h3>
            <ul className="flex flex-col gap-1.5">
              <li className="text-sm text-gray-500 font-normal">
                • Hủy trước 3 ngày: hoàn tiền 100%
              </li>
              <li className="text-sm text-gray-500 font-normal">
                • Hủy trong vòng 3 ngày: hoàn tiền 50%
              </li>
              <li className="text-sm text-gray-500 font-normal">
                • Sau khi nhận phòng: không hoàn tiền
              </li>
            </ul>
          </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm sticky top-24 flex flex-col gap-4">
