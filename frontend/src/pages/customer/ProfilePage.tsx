    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          value={user?.email ?? ''}
          disabled
          className="border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-gray-50 text-gray-400 cursor-not-allowed w-full"
        />
      ...
      <button
        ...
        className="bg-primary hover:bg-primary-dark disabled:opacity-60 disabled:cursor-not-allowed text-white py-2.5 rounded-xl text-sm font-medium flex items-center justify-center gap-2 mt-2 transition-colors"
      >
        {isSubmitting && (
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          <input
            ...
            className="border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary w-full pr-16"
          />
          <button
            type="button"
...
const ProfilePage = () => {
  ...
  return (
    <div className="max-w-xl mx-auto py-8 px-4">
      <h1 className="text-xl font-medium text-gray-800 mb-6">Hồ sơ cá nhân</h1>
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="font-medium text-gray-800 mt-2">{user?.fullName}</p>
        <p className="text-sm text-gray-500">{user?.email}</p>

        {user?.role && (
          <span className={`mt-2 text-xs font-medium px-2.5 py-1 rounded-full ${ROLE_CLASS[user.role] ?? 'bg-gray-100 text-gray-600'}`}>
