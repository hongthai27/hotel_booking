  ...
  return (
    ...
    <div className="grid md:grid-cols-2 gap-6">
      {[
        {
          tag: 'Hot Deal',
          title: 'Đặt sớm — Tiết kiệm 15%',
          desc: 'Đặt phòng trước 30 ngày để nhận ưu đãi 15% cho tất cả hạng phòng.',
          condition: 'Áp dụng cho đặt phòng từ nay đến 31/9/2026',
          badge: '-15%',
          code: 'EARLY15',
        },
        {
          ...
          desc: 'Đặt phòng từ 3 đêm trở lên được tặng thêm 1 đêm miễn phí.',
          condition: 'Áp dụng cho Phòng Deluxe và Suite',
          badge: '+1 đêm',
          code: 'STAY3GET1',
        },
        {
          tag: 'Family',
          title: 'Gói gia đình — Tiết kiệm 20%',
          desc: 'Đặt Phòng Family cho 4 người trở lên, giảm ngay 20% tổng hóa đơn.',
          condition: 'Áp dụng cuối tuần và ngày lễ',
          badge: '-20%',
          code: 'FAMILY20',
        },
        {
          tag: 'Member',
          title: 'Khách thân thiết — Ưu đãi riêng',
          desc: 'Khách đã ở từ 3 lần trở lên nhận ưu đãi đặc biệt và ưu tiên chọn phòng.',
          condition: 'Đăng ký tài khoản để tích lũy ngay',
          badge: 'VIP',
          code: 'VIPMEMBER',
        },
      ].map((promo, i) => (
        <div key={i}
          ...
          <div className="bg-[#17365D] p-6 md:p-8 flex flex-col relative overflow-hidden">
            ...
            <h3 className="relative z-10 text-xl font-medium text-white mb-2">{promo.title}</h3>
            <span className="relative z-10 text-4xl md:text-5xl font-bold text-amber-400 tracking-tight">{promo.badge}</span>
          </div>
          ...
          <div className="p-6 md:p-8 flex-1 flex flex-col bg-white">
            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-6 border border-gray-100 flex items-start gap-3">
              ...
              <p className="text-sm text-gray-500 italic">{promo.condition}</p>
            </div>
